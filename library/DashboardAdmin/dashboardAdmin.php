        ...
        <div class="container-fluid p-3">
            ...
            <div class="dropdown">
                <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../assets/adminLogo.png" alt="adminLogo" width="30px"> <!-- Mengurangi ukuran logo admin -->
                </button>
                <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
                    <li>
                        <a class="dropdown-item text-center" href="#">
                            <img src="../assets/adminLogo.png" alt="adminLogo" width="25px"> <!-- Mengurangi ukuran gambar dalam dropdown -->
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-2">
                        <div class="cardImg">
                            <a href="member/member.php">
                                <img class="img-hover" src="../assets/new/member.png" alt="daftar buku">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="cardImg">
                            <a href="peminjaman/peminjamanBuku.php">
                                <img class="img-hover" src="../assets/new/peminjaman.png" alt="daftar buku">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="cardImg">
                            <a href="pengembalian/pengembalianBuku.php">
                                <img class="img-hover" src="../assets/new/pengembalian.png" alt="daftar buku">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="cardImg">
                            <a href="denda/daftarDenda.php">
                                <img class="img-hover" src="../assets/new/denda.png" alt="daftar buku">
                            </a>
                        </div>
                    </div>
                </div>
