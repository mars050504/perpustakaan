...
// Eksekusi kueri SQL menggunakan mysqli_query()
$query = "SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, buku.kategori, pengembalian.nisn, member.nama, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
...
$dataPengembalian = [];
if ($result) {
  // Mengambil data hasil kueri dan menyimpannya dalam array
  while ($row = mysqli_fetch_assoc($result)) {
    $dataPengembalian[] = $row;
  }
}
