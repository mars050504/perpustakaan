  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Perpus</span>Rek</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">PerpusRek!!</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width <a href="" class="text-decoration-none">Kelompok 4</a>  2024
        </p>
        </div>
      </div>
    </footer>
